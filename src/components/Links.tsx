    ...
    return (
      <section className="mb-8">
        ...
        <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
          Prompt list created by <a href="https://twitter.com/erindale_xyz" className="text-blue-500">@erindale_xyz</a>, shared with permission. This site is a community-led initiative and not affiliated with the original Nodevember team.
        </p>
      </section>
    )
  }
